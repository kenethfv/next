...
//! En build time esto sirve para generar paginas en estatico de una vez en la compilacion
...
const getPokemon = async (name: string): Promise<Pokemon> => {
  try {
    const pokemon = await fetch(`https://pokeapi.co/api/v2/pokemon/${name}`, {
      ...
      next: {
        //! Revalidación de la generación estatica de los consumos
        //! Funciona solo para Fetch, aparte con axios es diferente
